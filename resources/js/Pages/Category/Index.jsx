...
export default function Index({category}){
    ...
    const handleDelete = (e, item) => {
        e.preventDefault();
        router.delete(route('category.destroy', item.id), {
            onSuccess: (page) => { 
            ...
            onError: (errors) => {
                toast.error("Failed to delete the category. Please check your input.");
    ...
    const handleSave = (e) => {
        ...
        if (mode == 'edit'){
            router.put(route('category.update', id),{
                name:name,
                detail:detail,
                status:status
            },{
                ...
                onError: (errors) => {
                    toast.error("Failed to save the category. Please check your input.");
                    console.error(errors);
                }
            })
        }else{
                                    ...
                                    <div>
                                        {
                                            ...
                                            : 
                                                <div><h2 className="font-bold text-lg" >Tambah Kategori</h2></div>
                                        }
